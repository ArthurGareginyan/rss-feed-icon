...
The preferred way to report bugs is to use the [GitHub issue tracker](https://github.com/ArthurGareginyan/rss-feed-icon/issues). Before reporting a bug, read these pointers.
