        ...
        <div id="post-body-content" class="has-sidebar-content">
            <div class="meta-box-sortabless">
                ...
                <form action="options.php" method="post" enctype="multipart/form-data">
                                    ...
                                    <td>
                                        ...
                                        <div class="integrated-icons">
                                            <table width="50%" border="0" cellspacing="15" cellpadding="0">
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="1" <?php checked('1', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/1.png'; ?>" width='48' height='48' />
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="2" <?php checked('2', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/2.png'; ?>" width='48' height='48' />
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="3" <?php checked('3', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/3.png'; ?>" width='48' height='48' />
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="4" <?php checked('4', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/4.png'; ?>" width='48' height='48' />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="5" <?php checked('5', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/5.png'; ?>" width='48' height='48' />
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="6" <?php checked('6', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/6.png'; ?>" width='48' height='48' />
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="7" <?php checked('7', $options['integrated_icon']); ?>>
                                                        <img src="<?php echo $plugin['url'] . 'inc/img/icons/7.png'; ?>" width='48' height='48' />
                                                    </td>
                                                    <td>
                                                        <input type="radio" name="spacexchimp_p013_settings[integrated_icon]" value="8" <?php checked('8', $options['integrated_icon']); ?>>
                    ...
                    <!-- HIDDEN -->
                    <?php
                        spacexchimp_p013_control_hidden( 'hidden_scrollto',
                                                         '0'
                                                       );
                    ?>
                    <!-- END HIDDEN -->
                    ...
                    <div class="postbox" id="preview">
                        ...
                        <div class="inside">
                            <div class="preview-icon">
                                <?php echo spacexchimp_p013_generator(); ?>
                            </div>
                        </div>
                    </div>
                    <!-- END PREVIEW -->
