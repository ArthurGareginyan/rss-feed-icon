    ...
    <div class="inner-sidebar">
        <div id="side-sortables" class="meta-box-sortabless ui-sortable">
            ...
            <div class="postbox about">
                ...
                <div class="inside">
                    <p><?php _e( 'This plugin gives you the ability to easily and safely add a RSS feed icon to any place (post content, page content, widget, sidebar, header, footer) of your WordPress website. RSS feed icon allows your visitors to receive messages from your Blog/RSS feed by email.', $plugin['text'] ); ?></p>
                </div>
            </div>
            <!-- END ABOUT -->
