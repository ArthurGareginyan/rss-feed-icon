...
/**
 * Upgrade plugin data in the database to version 2.9
 */
function spacexchimp_p013_upgrade_2_9() {

    // Upgrade number
    $upgrade_number_new = '0001';
    $prefix_old = 'RssFeedIcon';
    $prefix_new = 'spacexchimp_p013';
