 ...
 * @since 2.2
 */
function RssFeedIcon_plugin_version_number() {
    ...
    if ( $new_number == $current_number ) {
        ...
        if ( $info['old_version'] == '1' ) {
            ...
            $info['old_version'] = '0';
            update_option( RSSFI_SETTINGS . '_service_info', $info );
...
RssFeedIcon_plugin_version_number();
