 ...
 */
function spacexchimp_p013_load_scripts_dynamic_js( $options, $prefix ) {
 ...
 */
function spacexchimp_p013_load_scripts_dynamic_css( $options, $prefix ) {
...
function spacexchimp_p013_load_scripts_admin( $hook ) {
    ...
    spacexchimp_p013_load_scripts_dynamic_js( $options, $prefix );

    // Call the function that contains the dynamic CSS
    spacexchimp_p013_load_scripts_dynamic_css( $options, $prefix );
