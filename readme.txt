...
If you would like to add a translation to this plugin then please head to our [Translating WordPress](https://translate.wordpress.org/projects/wp-plugins/rss-feed-icon) page.
...
After installation, a "`RSS Feed Icon`"  menu item will appear in the "`Settings`" section. Click on this in order to view plugin's administration page.
...
A. Please visit the [Dedicated Plugin Page on GitHub](https://github.com/ArthurGareginyan/rss-feed-icon) and report.
